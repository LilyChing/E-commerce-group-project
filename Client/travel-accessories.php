...
<html>
  ...
  <nav class="navbar navbar-expand-lg " style="background: linear-gradient(135deg, #65ACFF, #ABD2FF)">
    ...
    <!-- navBar -->
        ...
        <?php
          echo productCard(1021,"1.jpg","RIMOWA - Check-In L","Rimowa's Check-In series is designed for larger storage capacity,<br>  making it ideal for longer trips.","1888");
          echo productCard(1022,"2.jpg","RIMOWA - Cabin Twist","Rimowa's classic line, known for its durability and stylish appeal.","1888");
          echo productCard(1023,"3.jpg","RIMOWA - Cabin","Rimowa is a premium luggage brand recognized for its<br> quality craftsmanship and stylish aesthetics.","1888");
          echo productCard(1024,"4.jpg","KSamsonite - GLOBAL Korea","This design is intended for comfort during travel,<br> providing support for the neck.","388");
          echo productCard(1025,"5.jpg","Samsonite - ZIRA","A large navy blue suitcase with a sleek design.","888");
        ?>
